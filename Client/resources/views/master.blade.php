...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-fixed-top">
      ...
      <a class="navbar-brand" href="#">NjjuuuTubes</a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-2 col-md-6">
              <input class="form-control mr-sm-5" type="search" placeholder="Search" aria-label="Search">
              <button class="btn btn-outline-success my-2 my-sm-0" type="submit" id="searchhome">Search</button>
            </form>
            <ul class="nav navbar-nav navbar-right">
              <li class="mr-sm-5 nav-item"><a href="{{('/register')}}">Sign Up</a></li>
              <li class="mr-sm-3"><a href="{{('/login')}}">Login</a></li>
            </ul>
          </div>
      <div id="wrapper">
